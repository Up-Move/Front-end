...
@SuppressWarnings({"Convert2Lambda", "SpellCheckingInspection", "ConstantConditions"})
public class TelaLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaologin = findViewById(R.id.botaoemail);
                ...
                if(event.getAction() == MotionEvent.ACTION_UP) {
                    if(event.getRawX() >= senhalogin.getRight()-senhalogin.getCompoundDrawables()[Right].getBounds().width()){
                        ...
                        if(senhaVisivel) {
                            ...
                            senhalogin.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, R.drawable.icon_eye_close, 0);
                            ...
                            // Imagem que será desenhada quando senha não for mostrada
                            senhalogin.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, R.drawable.icon_eye_open, 0);
                ...
                call.enqueue(new Callback<JsonObject>() {
                    ...
                    public void onResponse(@NonNull Call<JsonObject> call, @NonNull Response<JsonObject> response) {
                        if (response.isSuccessful()) {
                            ...
                            //userManager.setUserLogin(userLogin);
        ...
        // Mandar para Tela Esqueci a Senha
        TextView esqueciMinhaSenha = findViewById(R.id.esqueci_minha_senha);

        esqueciMinhaSenha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Inicie a atividade para redefinir a senha
                Intent intent = new Intent(TelaLogin.this, TelaAlterarSenhaEmail.class);
                startActivity(intent);
            }
        });
    ...
    private void checkAndStartNextScreen() {
        ...
        if (!authToken.isEmpty()) {
            ...
            Intent intent = new Intent(TelaLogin.this, TelaMapaAutenticado.class);
            startActivity(intent);
            finish();
        } else {
