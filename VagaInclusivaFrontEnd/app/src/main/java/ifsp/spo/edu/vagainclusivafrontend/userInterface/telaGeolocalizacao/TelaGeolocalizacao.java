...
import ifsp.spo.edu.vagainclusivafrontend.userInterface.telaPermissaoTelefone.TelaPermissaoTelefone;
...
public class TelaGeolocalizacao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPermitir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(TelaGeolocalizacao.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    Intent intent = new Intent(TelaGeolocalizacao.this, TelaPermissaoTelefone.class);
        ...
        // Verificar permissão de geolocalização no início
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            // Se a permissão já foi concedida, abra a próxima Activity
            Intent intent = new Intent(this, TelaPermissaoTelefone.class);
            startActivity(intent);
            finish();
        }
