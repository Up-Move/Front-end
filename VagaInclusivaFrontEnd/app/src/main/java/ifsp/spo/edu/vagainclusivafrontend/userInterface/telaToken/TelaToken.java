...
public class TelaToken extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String token_aleatorio = getIntent().getStringExtra("token_aleatorio");
        ...
        botaotoken.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditText validartoken = findViewById(R.id.emaillogin);
                ...
                requestBody.put("token_aleatorio", token_aleatorio);
